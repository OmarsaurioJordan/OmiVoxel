# Creador de graficos 2.5D estilo Voxel, por Omwekiatl 2020
...
# el modo de pruebas no tiene try, por lo que mostrara errores
debug = True
# constantes internas: talla del lienzo, camara, centro y gravedad
...
acGrav = 9.8
# constantes de interaccion entre voxels y luz:
# paso de rayo, colision^2 para luz, distancia al sol, ancho de zonas,
#   luz ambiente %, fuerza de luz 0-255, colision^2 para voxels
cnfgluz = [6, 100, 100000, 50, 0.3, 255, 36]
# estructura de todos los voxels:
pos = np.zeros((0, 3), dtype=float) # posicion de cada voxel
col = np.zeros((0, 4), dtype=int) # color de cada voxel
gru = np.zeros(0, dtype=int) # grupo de cada voxel
ren = col.copy() # ultimo color renderizado de cada voxel
...
def kill():
    return "la vida esta sobrevalorada" + 69
